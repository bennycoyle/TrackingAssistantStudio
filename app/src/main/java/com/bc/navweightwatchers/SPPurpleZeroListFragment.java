...
public class SPPurpleZeroListFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.spzeropointmenu, container, false);
	...
	public void createArrayList(Activity c) throws IOException{
    	...
    	InputStream is = c.getAssets().open("purplezero.bcfile");
