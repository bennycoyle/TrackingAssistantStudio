...
public class ExerFragment extends Fragment implements OnTouchListener {
	...
	View rootView;
	CommonFunctions cf;
	private double low = 0.073392817;
	private double med = 0.102374383;
	private double high = 0.254580857;

	public static Fragment newInstance(Context context) {
    	ExerFragment f = new ExerFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        if (unit.equals("0")) {
        	rootView = inflater.inflate(R.layout.exercisemenu_kgs, container, false);
        	setupMetricGUIIds();
        	...
        	rootView = inflater.inflate(R.layout.exercisemenu_lbs, container, false);
        	setupImperialGUIIds();
    ...
    public void onResume() {
    	...
    	if ( resumeCount == 0 ) {
        	...
        	Fragment frag = new ExerFragment();
