...
import androidx.core.app.ListFragmentLayout;
...
public class SPPurpleListFragment extends ListFragment {
	...
	public void createHashMap(Activity c) throws IOException{
    	...
    	InputStream is = c.getAssets().open("purplesmartpoints.bcfile");
    	...
    	while ((line = in.readLine()) != null) {
			...
			if(parts[1].toString().equals(" ") && parts.length == 2 ) {
				map.put("Points", " ");
			} else {
